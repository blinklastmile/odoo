...
class StockAdjustment(http.Controller):
    ...
    def sh_barcode_scanner_get_widget_data(self, **post):
        ...
        values['sh_inven_adjt_barcode_scanner_auto_close_popup'] = request.env.company.sudo().sh_inven_adjt_barcode_scanner_auto_close_popup 
        values['sh_inven_adjt_barcode_scanner_warn_sound'] = request.env.company.sudo().sh_inven_adjt_barcode_scanner_warn_sound 
