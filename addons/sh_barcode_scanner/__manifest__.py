...
#         "views/assets_backend.xml",
    ...
    "assets": {
        "web.assets_backend": [
            "sh_barcode_scanner/static/src/scss/style.scss",
            "sh_barcode_scanner/static/src/js/dialog_sound.js",
            "sh_barcode_scanner/static/src/js/dialog.js",            
            "sh_barcode_scanner/static/src/js/global_doc_search/global_doc_search.js",
            "sh_barcode_scanner/static/src/js/stock_adjustment2.js",
        ],
        'web.assets_qweb': [
            'sh_barcode_scanner/static/src/xml/global_doc_search/global_doc_search.xml',
            'sh_barcode_scanner/static/src/xml/stock_adjustment.xml'
        ],
